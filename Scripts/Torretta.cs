...
public class Torretta : MonoBehaviour {
    ...
    public float danno, raggio, attacchiPerSecondo;
	...
	// Update is called once per frame
 	public virtual void Update () {
		...
		{
			collisori = Physics.OverlapSphere(transform.position, raggio, nemici);
    ...
    {
        proiettile.GetComponent<Proiettile>().danno = danno;
